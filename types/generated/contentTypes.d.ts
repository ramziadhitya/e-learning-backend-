...
export interface ApiCourseCourse extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    certification: Schema.Attribute.Boolean;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Blocks;
    ...
    level: Schema.Attribute.Enumeration<
      ['Beginner', 'Intermediate', 'Hard', 'All Level']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    studentsCount: Schema.Attribute.BigInteger;
...
export interface ApiDetailDetail extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    skillLevel: Schema.Attribute.Enumeration<
      ['Basic', 'Intermediate', 'Advanced', 'All Level']
    >;
    slug: Schema.Attribute.UID;
    studentsCount: Schema.Attribute.BigInteger;
...
export interface ApiLessonLesson extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    lesson: Schema.Attribute.Component<'shared.lesson', false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::lesson.lesson'
